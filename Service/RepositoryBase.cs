...
namespace Service
{
    public abstract class RepositoryBase<T> : IRepository<T> where T : class
    {
        ...
        DbContext IRepository<T>.Context
        {
            get
            {
        ...
        T IRepository<T>.SaveOrUpdate(T entity, bool isEdit)
        {
            throw new NotImplementedException();
        }

        public bool IsExit(Expression<Func<T, bool>> pression)
        {
            throw new NotImplementedException();
        }

        public bool IsExitSql(string sql, DbParameter param)
        {
            throw new NotImplementedException();
        }
