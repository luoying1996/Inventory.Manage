...
namespace Service
{
    public interface IRepository<T> where T : class
    {
        ...
        T SaveOrUpdate(T entity, bool isEdit);

        int Delete(Expression<Func<T, bool>> predicate = null);

        int DeleteBySql(string sql, params DbParameter[] pars);

        bool IsExit(Expression<Func<T, bool>> pression);

        bool IsExitSql(string sql, DbParameter param);
